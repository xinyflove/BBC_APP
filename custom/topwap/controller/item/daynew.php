 ...
 * 每日上新页控制器
 */
class topwap_ctl_item_daynew extends topwap_controller {
    ...
    public function index()
    {
		...
		$url= url::action("topwap_ctl_item_daynew@index",$filter);
		...
		/*add_2017/11/10_by_wanghaichao_end*/
        return $this->page('topwap/item/day_new/index.html', $pagedata);
    }
    ...
    public function ajaxGetItemList()
    {
        ...
        if($pagedata['items'])
        {
            return view::make('topwap/item/day_new/item_list.html',$pagedata);
        }
    }
}
