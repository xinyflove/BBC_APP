<?php
class sysactivityvote_api_activeUpdate {

    public $apiDescription = "修改投票活动信息";

    public function getParams()
    {
        $return['params'] = array(
            'active_id' => ['type'=>'int','valid'=>'required','desc'=>'投票活动id','default'=>'','example'=>'1'],
    ...
    public function update($params)
    {
        ...
        $res = $objMdlActive->update($data, array('active_id'=>$params['active_id']));
