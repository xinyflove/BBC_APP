<?php
class topshop_ctl_trade_callList extends topshop_controller{
    public $limit = 10;
    ...
    public function index()
    {
        ...
        $pagedata['channel_list'] = $channel_list;
        return $this->page('topshop/trade/call_list.html', $pagedata);
    }
    ...
    public function search()
    {
        ...
        $params = array(
            ...
            'fields' =>'order.spec_nature_info,shipping_type,tids,shop_id,user_id,status,payment,points_fee,total_fee,post_fee,payed_fee,receiver_name,trade_memo,created_time,receiver_mobile,discount_fee,adjust_fee,seat,exchange_code,order.title,order.price,order.num,order.pic_path,order.tid,order.oid,order.item_id,need_invoice,invoice_name,invoice_type,invoice_main,pay_type,cancel_status,receiver_idcard,order.is_virtual,is_cross,identity_card_number,order.init_shop_id',
        );

        //显示订单售后状态
        $params['is_aftersale'] = true;
        $params['shop_id'] = $this->shopId;
        $params['trade_from'] = 'call';
        ...
        return view::make('topshop/trade/call_item.html', $pagedata);
    }
    ...
    private function __pager($postFilter,$page,$count)
    {
        ...
        $pagers = array(
            'link'=>url::action('topshop_ctl_trade_callList@search',$postFilter),
            'current'=>$page,
            'use_app' => 'topshop',
            'total'=>$total,
            'token'=>time(),
