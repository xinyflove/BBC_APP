...
class topstore_ctl_selector_item extends topstore_controller {
    public $limit = 14;
    ...
    public function loadSelectGoodsModal()
    {
        ...
        return view::make('topstore/selector/item/index.html', $pagedata);
    }
    ...
    public function formatSelectedGoodsRow()
    {
        ...
        return view::make('topstore/selector/item/input-row.html', $pagedata);
    }
    ...
    public function searchItem($json=true)
    {
        ...
        if(trim($brandName) && trim($brandName) != 'undefined')
        {
            ...
            {
                return view::make('topstore/selector/item/list.html', $pagedata);
            }
        }
        ...
        $filter['pages'] = time();
        $pagers = array(
            'link' => url::action('topstore_ctl_selector_item@searchItem', $filter),
            'current' => $pages,
            'use_app' => 'topshop',
            'total' => $totalPage,
            'token' => time(),
    ...
    public function getSkuByItemId()
    {
        ...
        $pagedata['image_default_id'] = kernel::single('image_data_image')->getImageSetting('item');
        return view::make('topstore/selector/item/skus.html', $pagedata);
    }
    ...
    public function showSkuByitemId()
    {
        ...
        return view::make('topstore/selector/item/show_skus.html', $pagedata);
    }
}
