...
class topshop_ctl_aftersalesmuumi extends topshop_controller {
    ...
    public function index()
    {
        ...
        $this->contentHeaderTitle = app::get('topshop')->_('推送商品退换货管理');

        return $this->page('topshop/aftersalesmuumi/list.html', $pagedata);
    }
    ...
    private function __searchListData()
    {
        ...
        $data['pagers'] = array(
            'link'=>url::action('topshop_ctl_aftersalesmuumi@search',$filter),
            'current'=>$current,
            'total'=>$total,
            'use_app'=>'shop',
            'token'=>$filter['pages'],
    ...
    public function detail()
    {
        ...
        catch(Exception $e)
        {
            ...
            redirect::action('topshop_ctl_aftersalesmuumi@index')->send();exit;
        }
        ...
        $this->contentHeaderTitle = app::get('topshop')->_('推送商品退换货详情');
        //面包屑
        $this->runtimePath = array(
            ['url'=> url::action('topshop_ctl_index@index'),'title' => app::get('topshop')->_('首页')],
            ['url'=> url::action('topshop_ctl_aftersalesmuumi@index'),'title' => app::get('topshop')->_('推送商品退换货管理')],
            ['title' => app::get('topshop')->_('推送商品退换货详情')],
        );
        ...
        return $this->page('topshop/aftersalesmuumi/detail.html', $pagedata);
    }
    ...
    public function search()
    {
        ...
        return view::make('topshop/aftersalesmuumi/item.html', $pagedata);
    }
    ...
    public function sendConfirm()
    {
        ...
        try
        {
            ...
            $aftersales = $objMdlAftersales->getRow('shop_id, init_shop_id', ['aftersales_bn' => $postdata['aftersales_bn']]);
            if($aftersales['init_shop_id'] != $this->shopId){
                throw new \LogicException('参数错误!');
            }
            $postdata['shop_id'] = $aftersales['shop_id'];

            $result = app::get('topshop')->rpcCall('aftersales.send.confirm',$postdata);
        }
        ...
        $url = url::action('topshop_ctl_aftersalesmuumi@detail', array('bn'=>$postdata['aftersales_bn']));
        $msg = '操作成功';
