 ...
 * Desc: 创客后台首页
 */
class topwap_ctl_maker_center extends topwap_controller {
    ...
    public function index()
    {
        ...
        $pagedata['my_shop_goods_url'] = '';//自选商品
        $pagedata['my_shop_setting_url'] = url::action('topwap_ctl_maker_setting@indexMaker');//小店设置
