...
class topwap_theme_helper{
    ...
    function function_header(){
        ...
        if($debug_css){
            /*modify_20171018_by_fanglongji_start*/
            /*
            ...
            */
            ...
            <link rel="stylesheet" href="'.$pathtopwap.'/stylesheets/debug/style.css'.$cssver.'" />
            <link rel="stylesheet" href="'.$pathtopwap.'/stylesheets/debug/widgets.css'.$cssver.'" />
            <link rel="stylesheet" href="'.$pathtopwap.'/stylesheets/swiper.min.css'.$cssver.'" />
            <link rel="stylesheet" href="'.$pathtopwap.'/stylesheets/debug/newtv.css'.$cssver.'" />';
            /*modify_20171018_by_fanglongji_end*/
        } else {
            /*modify_20171018_by_fanglongji_start*/
            /*
            ...
            */
            $ret.='<link rel="stylesheet" href="'.$pathtopwap.'/stylesheets/min/style.min.css'.$cssver.'" />
            <link rel="stylesheet" href="'.$pathtopwap.'/stylesheets/swiper.min.css'.$cssver.'" />
            <link rel="stylesheet" href="'.$pathtopwap.'/stylesheets/min/newtv.min.css'.$cssver.'" />';
            /*modify_20171018_by_fanglongji_end*/
        }
