<?php
class topshop_ctl_trade_callDetail extends topshop_controller{
    public function index()
    {
        ...
        */
        ...
        return $this->page('topshop/trade/call_detail.html', $pagedata);
    }
    ...
    public function setTradeMemo()
    {
        ...
        $url = url::action('topshop_ctl_trade_callDetail@index',array('tid'=>$params['tid']));
