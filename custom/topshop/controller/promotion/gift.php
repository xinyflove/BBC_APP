...
class topshop_ctl_promotion_gift extends topshop_controller{
    ...
    public function show_gift()
    {
        ...
        $pagedata['gradeList'] = app::get('topshop')->rpcCall('user.grade.list',['shop_id' => $shopid]);
    ...
    public function edit_gift()
    {
        ...
        $valid_grade = explode(',', $pagedata['valid_grade']);
        $pagedata['gradeList'] = app::get('topshop')->rpcCall('user.grade.list',array('shop_id'=>$shopId));
