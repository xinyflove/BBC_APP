...
class sysmall_finder_widgets_instance {
    ...
    public function column_edit(&$colList, $list)
    {
        ...
        {
            $urltmpl = '?app=sysmall&ctl=page&act=edit&tmpl='.$row['tmpl'].'&finder_id='.$_GET['_finder']['finder_id'].'&p[0]='.$row['widgets_id'];
            ...
            $url = '?app=sysmall&ctl=widgets&act=edit_widgets&tmpl='.$row['tmpl'].'&finder_id='.$_GET['_finder']['finder_id'].'&p[0]='.$row['widgets_id'];
