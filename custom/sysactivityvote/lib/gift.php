...
class sysactivityvote_gift {
    ...
    // {
    //     $objMdlExpert = app::get('sysactivityvote')->model('gift');
    ...
    //  * @return bool       是否保存成功
    //  */
    // public function saveExpert($giftData)
    // {
    ...
    public function getInfo($row,$filter)
    {
        ...
        $gift = $objMdlGift->getRow($row,$filter);
